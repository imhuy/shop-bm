...
const InfoModal: FC<IChangePasswordModal> = ({ isOpen, closeModal }) => {
            ...
            >
              <Dialog.Panel className="w-full max-w-xl rounded-sm transform overflow-hidden rounded-ms bg-white p-6 text-left align-middle shadow-xl transition-all">
                ...
                <div className="mt-8 flex flex-col gap-y-6">
                  ...
                  <p className=" text-base">
                    BM1 limit 250$ có một tài khoản quảng cáo, giới hạn 5 tài
                    khoản trong BM sau khi chạy
                  </p>
                  <p className=" text-base">
                    Bảo hành trong 24h (lỗi link, die bm khi chưa sử dụng, tụt
                    ngưỡng), 4 tài khoản sau tạo múi giờ tiền tệ theo mong muốn.
                  </p>{" "}
                  <p className=" text-base">
                    Không bảo hành với trường hợp add thẻ, tạo tài khoản quảng
                    cáo.
                  </p>
                  <p className=" text-base">
                    BM1 limit 250$ has an ad account, limit 5 accounts in BM
                    after running
                  </p>
                  <p className=" text-base">
